...
struct GlobalConstants {
    ...
    struct ColorLightTheme {
        ...
        static let lightGray = Color(#colorLiteral(red: 0.9333333333, green: 0.9333333333, blue: 0.9333333333, alpha: 1))
    ...
    struct ColorDarkTheme {
        static let darkGray = Color(#colorLiteral(red: 0.1333333333, green: 0.1568627451, blue: 0.1921568627, alpha: 1))
        static let lightGray = Color(#colorLiteral(red: 0.2235294118, green: 0.2431372549, blue: 0.2745098039, alpha: 1))
        static let blue = GlobalConstants.colorBlue
